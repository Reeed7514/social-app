<template>
	<div>
		<div class="flex items-center flex-shrink-0 p-4 pb-0">
			...
			<div class="w-full p-2">
				<textarea v-model="text"
					class="w-full h-40 text-lg text-gray-900 dark:text-white placeholder:text-gray-400 outline-none bg-transparent border-1 rounded-md focus:ring-0"
		...
		<div class="pl-16">
			...
			<img :src="imageInputUrl" v-if="imageInputUrl" class="w-32 h-auto border rounded-xl" :class="twitterBorderColor">

			<input ref="imageInput" type="file" hidden accept="image/png, image/jpeg, image/gif" @change="handleImageChange" :placeholder="props.placeholder">

		</div>

		<!-- Icons -->
		<div class="flex pb-2 pl-16 pr-7">
